...
font=('arial',15),height=12,width=47,selectbackground="white",selectforeground="red")
...
#play button
play_button = Button(root,command=Play,text="Play",width=7)
play_button['font']=defined_font
play_button.grid(row=1,column=1)

#Stop button
stop_button = Button(root,text="Stop",width=7,command=Pause)
